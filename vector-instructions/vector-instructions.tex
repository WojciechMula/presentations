...
\frame{
    ...
    \begin{itemize}
        \pause
        \item What are \textbf{vector instructions} or \textbf{SIMD instructions}
        \pause
...
\frame{
    ...
    \begin{itemize}
        ...
        \pause
        \item A computer can execute either \textbf{single} or \textbf{multiple} instructions at once
        \pause
...
\frame{
    \frametitle{How does vector instruction work then? --- part 1}
...
\frame{
    \frametitle{How does vector instruction work then? --- part 2}
...
\frame{
    ...
    For instance a 256-bit vector can be used in a program as a value of type (C/C++ types):
...
\frame{
    \frametitle{Existing SIMD implementation}
...
\frame{
    ...
    \begin{itemize}
        ...
        \pause
        \item \textbf{blending} two vectors
        \pause
        \item \textbf{integer saturated arithmetic}
    \end{itemize}
}
...
\frame{
    ...
    \begin{itemize}
        ...
        \pause
        \item Traditional (modulo) arithmetic:
        \pause
...
\frame{
    ...
    How about adding two vector of arbitrary size?
...
\frame{
    ...
    \begin{itemize}
        ...
        \pause
        \item finding index of min elemment: \hfill
              14 x faster
    \end{itemize}
}
...
\frame{
    ...
    \begin{itemize}
        ...
        \pause
        \item Exception is C extension \textbf{ispc} \href{https://ispc.github.io/}
        \pause
...
\frame{
    ...
    \begin{itemize}
        \pause
        \item SIMD instructions are ubiquites
        \pause
        \item SIMD can give significant speedup
        \pause
        \item \ldots but doesn't make program magically faster
        \pause
        \item SIMD instructions are quite hard to master by programmers
        \pause
        \item \ldots mental model is different
        \pause
